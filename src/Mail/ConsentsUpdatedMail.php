...
class ConsentsUpdatedMail extends Mailable
{
    ...
    public function build()
    {
        ...
        $content = view('vendor.ekoukltd.laraconsent.consent-options.'.config('laravel-admin-tools.css_format').'.widgets._viewUserPrint',['consentOptions'=>$consentOptions])->render();
